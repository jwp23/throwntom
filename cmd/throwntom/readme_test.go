...
func TestREADMEIncludesInstallAndCommands(t *testing.T) {
...
func TestGoModulePathIsPublishable(t *testing.T) {
	...
	if !strings.Contains(string(content), "module github.com/jwp23/throwntom/v3") {
		t.Fatalf("expected go.mod module path to be github.com/jwp23/throwntom/v3")
	}
}
