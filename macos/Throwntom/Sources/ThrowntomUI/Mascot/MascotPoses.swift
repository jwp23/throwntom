...
extension MascotPose {
  ...
  static let work = MascotPose(
    eyes: .open,
    mouth: .smile,
    leftArm: Arm(33.5, 75, 25.5, 83.5, 32.1, 91.1, 47.2, 92.2),
    rightArm: Arm(71.1, 80.9, 77.2, 90.4, 76, 96.3, 70.7, 97.2),
    held: nil,
    furniture: .laptop,
    rotation: -12,
    scale: 1,
  ...
  static let shortBreak = MascotPose(
    eyes: .closed,
    mouth: .smile,
    leftArm: Arm(22, 70, 16, 80, 22, 86, 35, 85),
    rightArm: Arm(78, 66, 88, 74, 84, 80, 71, 80),
    held: .drink,
    furniture: nil,
    rotation: -12,
    scale: 1,
  ...
  static let longBreak = MascotPose(
    eyes: .down,
    mouth: .smile,
    leftArm: Arm(26, 66, 16, 74, 22, 86, 34, 82),
    rightArm: Arm(74, 66, 84, 74, 78, 86, 66, 82),
    held: .book,
    furniture: .sofa,
    rotation: -10,
    scale: 0.8,
  ...
  static let idle = MascotPose(
    eyes: .down,
    mouth: .smile,
    leftArm: Arm(21.4, 64.3, 10, 70, 11.8, 80.6, 24.6, 83.3),
    rightArm: Arm(70.8, 72.7, 82.1, 77.2, 84.3, 85.8, 77, 91.4),
    held: .yoyo,
    furniture: nil,
    rotation: -12,
    scale: 1,
  ...
  static let awaitingConfirm = MascotPose(
    eyes: .wide,
    mouth: .open,
    leftArm: Arm(24, 62, 10, 54, 10, 40, 20, 29),
    rightArm: Arm(76, 62, 90, 54, 90, 40, 80, 29),
    held: .exclamation,
    furniture: nil,
    rotation: -12,
    scale: 1,
  ...
  static let disconnected = MascotPose(
    ...
    mouth: .flat,
    leftArm: Arm(22, 70, 16, 80, 22, 86, 35, 85),
    rightArm: Arm(78, 70, 84, 80, 78, 86, 65, 85),
    held: .cable,
    furniture: nil,
    rotation: -12,
    scale: 1,
