  ...
  func testBodyIsBuiltFromTheHeaderPlaceholderListAndHint() throws {
    ...
    XCTAssertEqual(
      ...
      "ModifiedContent<ModifiedContent<ModifiedContent<VStack<TupleView<(ModifiedContent<Text, "
        ...
        + "ForEach<Array<TaskItem>, Int, ModifiedContent<ModifiedContent<TaskRow, _TagTraitWritingModifier<Int>>, "
        + "ContextMenuModifier<ZStack<ModifiedContent<ModifiedContent<ModifiedContent<ModifiedContent<"
        + "ModifiedContent<TaskContextMenu, SectionStyleModifier<DefaultSectionStyle>>, "
        + "LabelStyleWritingModifier<DefaultLabelStyle>>, _EnvironmentKeyWritingModifier<Visibility>>, "
        + "ViewInputFlagModifier<LabelVisibilityConfigured>>, StyleContextWriter<MenuStyleContext>>>>>>, "
